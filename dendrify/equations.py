...
library = {
    ...
    'adex': '''
dV{0}/dt = (gL{0} * (EL{0}-V{0}) + gL{0}*DeltaT{0}*exp((V{0}-Vth{0})/DeltaT{0}) + I{0} - w{0}) / C{0}  :volt
...
''',
    ...
    'adaptiveIF': '''
dV{0}/dt = (gL{0} * (EL{0}-V{0}) + I{0} - w{0}) / C{0}  :volt
dw{0}/dt = (a{0} * (V{0}-EL{0}) - w{0}) / tauw{0}  :amp
I{0} = I_ext{0}  :amp
I_ext{0}  :amp
''',
    ...
    'leakyIF': '''
dV{0}/dt = (gL{0} * (EL{0}-V{0}) + I{0}) / C{0}  :volt
I{0} = I_ext{0}  :amp
I_ext{0}  :amp
''',
    # Leaky membrane
...
''',
    ...
    'AMPA': '''
I_AMPA_{1}_{0} = g_AMPA_{1}_{0} * (E_AMPA-V_{0}) * s_AMPA_{1}_{0} * w_AMPA_{1}_{0}  :amp
ds_AMPA_{1}_{0}/dt = -s_AMPA_{1}_{0} / t_AMPA_decay_{1}_{0}  :1
''',
    # AMPA equations with rise and decay kinetics
    'AMPA_rd': '''
I_AMPA_{1}_{0} = g_AMPA_{1}_{0} * (E_AMPA-V_{0}) * x_AMPA_{1}_{0} * w_AMPA_{1}_{0}  :amp
...
''',
    ...
    'GABA': '''
I_GABA_{1}_{0} = g_GABA_{1}_{0} * (E_GABA-V_{0}) * s_GABA_{1}_{0} * w_GABA_{1}_{0}  :amp
ds_GABA_{1}_{0}/dt = -s_GABA_{1}_{0} / t_GABA_decay_{1}_{0}  :1
''',
    # GABA equations with rise and decay kinetics
    'GABA_rd': '''
I_GABA_{1}_{0} = g_GABA_{1}_{0} * (E_GABA-V_{0}) * x_GABA_{1}_{0} * w_GABA_{1}_{0}  :amp
...
''',
    ...
    'NMDA': '''
I_NMDA_{1}_{0} = g_NMDA_{1}_{0} * (E_NMDA-V_{0}) * s_NMDA_{1}_{0} / (1 + Mg * exp(-alpha*(V_{0}/mV+gamma)) / beta) * w_NMDA_{1}_{0}  :amp
ds_NMDA_{1}_{0}/dt = -s_NMDA_{1}_{0}/t_NMDA_decay_{1}_{0}  :1
''',
    # NMDA equations with rise and decay kinetics
    'NMDA_rd': '''
I_NMDA_{1}_{0} = g_NMDA_{1}_{0} * (E_NMDA-V_{0}) * x_NMDA_{1}_{0} / (1 + Mg * exp(-alpha*(V_{0}/mV+gamma)) / beta) * w_NMDA_{1}_{0}  :amp
...
''',
    ...
    'run_on_Na_spike': '''
run_on_event('activate_I_Na_{0}', 'g_Na_{0} += g_Na_{0}_max; allow_I_Na_{0}=False; allow_I_Kn_{0}=True; timer_Na_{0} = t')
run_on_event('activate_I_Kn_{0}', 'g_Kn_{0} += g_Kn_{0}_max; allow_I_Kn_{0}=False; allow_I_Na_{0}=True')
''',
    'run_on_Ca_spike': '''
run_on_event('activate_I_Ca_{0}', 'g_Ca_{0} += g_Ca_{0}_max; allow_I_Ca_{0}=False; allow_I_Kc_{0}=True; timer_Ca_{0} = t')
